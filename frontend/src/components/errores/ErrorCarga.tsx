            ...
            <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50">
                ...
                <div className="flex items-center justify-center gap-x-6">
                    <a
                        ...
                        className="rounded-md bg-white px-3.5 py-2.5 text-sm font-semibold text-black shadow-xs transition-color ease-in-out duration-300 hover:bg-gray-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer"
                    >
                        Recargar
                    </a>
                </div>
